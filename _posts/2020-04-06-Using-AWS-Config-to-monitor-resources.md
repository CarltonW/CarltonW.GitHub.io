...
[ ![AWS Config settings](/img/AWSConfig/aws-console-config-settings-small.png) ](/img/AWSConfig/aws-console-config-settings.png)<center>Click on image to see larger version</center>
